    ...
    public class AutoMapperProfile : Profile
    {
        public AutoMapperProfile()
        {
            ...
            CreateMap<TournamentPlayer, TournamentPlayerDto>()
                ...
                .ForMember(d => d.PlayerRoundRobinGameWins, o => o.MapFrom(s => s.PlayerRoundRobinGameWins))
                .ForMember(d => d.PlayerRoundRobinGameDraws, o => o.MapFrom(s => s.PlayerRoundRobinGameDraws))
                .ForMember(d => d.PlayerRoundRobinGameLosses, o => o.MapFrom(s => s.PlayerRoundRobinGameLosses))
                .ForMember(d => d.PlayerSwissGameWins, o => o.MapFrom(s => s.PlayerSwissGameWins))
                .ForMember(d => d.PlayerSwissGameDraws, o => o.MapFrom(s => s.PlayerSwissGameDraws))
                .ForMember(d => d.PlayerSwissGameLosses, o => o.MapFrom(s => s.PlayerSwissGameLosses))
